...
sudo scutil --set ComputerName "WorkBook"
sudo scutil --set HostName "WorkBook"
sudo scutil --set LocalHostName "workbook"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "WorkBook"
